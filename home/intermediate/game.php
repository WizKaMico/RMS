            ...
            <th>CERTIFICATE</th>
					...
					<tbody>
						<?php
							...
							$sql = "SELECT *,registration.code as cod FROM registration LEFT JOIN runner ON registration.code = runner.code  WHERE registration.category = 'INTERMEDIATE RUN (3k)'";
