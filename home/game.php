                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav-tabs">
                                <li class="nav-item tab is-active" data-role="tab" data-target="#tabs-home3">OVERALL
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <form action="action/update_runner.php" method="POST">
                                    <input type="text" name="code" id="myTextInput" readonyy="" placeholder="scan qrcode" class="form-control">
                                </form>
                                
                                </div>

                                <div class="tab-panel" id="tabs-profile3">
                                <iframe src="kid/game.php" style="border:none; width:100%; height:500px;"></iframe>
                                
                                </div>
                                <div class="tab-panel" id="tabs-profile4">
                                <iframe src="short/game.php" style="border:none; width:100%; height:500px;"></iframe>
                               
                                </div>
                                <div class="tab-panel" id="tabs-messages3">
                                <iframe src="intermediate/game.php" style="border:none; width:100%; height:500px;"></iframe>
                              
                                </div>
                                <div class="tab-panel" id="tabs-messages4">
                                <iframe src="open/game.php" style="border:none; width:100%; height:500px;"></iframe>
